...
export class ChallengesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (user) {
      this.globalChallenges$ = this.dataService.getGlobalChallenges();
      const userActiveChallenges$ = this.dataService.getActiveUserChallenges(
        user.uid,
      );
      ...
      const completedChallenges$ = this.dataService.getCompletedUserChallenges(user.uid);
