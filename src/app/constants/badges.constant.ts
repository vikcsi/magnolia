...
export const BADGES: BadgeDefinition[] = [
  ...
  {
    id: 'goal_energy_saver',
    name: 'Energiatakarékos',
    description: 'Teljesítsd az "Energia diéta" célkitűzést.',
    icon: 'battery-charging',
    category: 'goal',
    rarity: 'rare',
    xpReward: 50,
    condition: { type: 'specific_goal_completed', targetId: 'goal_energy_saver' },
  },
  {
    id: 'goal_local_produce',
    name: 'Lokálpatrióta',
    description: 'Teljesítsd a "Helyi termékek" célkitűzést.',
    icon: 'storefront',
    category: 'goal',
    rarity: 'rare',
    xpReward: 50,
    condition: { type: 'specific_goal_completed', targetId: 'goal_local_produce' },
  },
  {
  ...
  },
  {
    id: 'goal_zero_waste',
    name: 'Hulladékvadász',
    description: 'Teljesítsd a "Tudatos csomagolás" célkitűzést.',
    icon: 'trash-bin',
    category: 'goal',
    rarity: 'rare',
    xpReward: 50,
    condition: { type: 'specific_goal_completed', targetId: 'goal_zero_waste' },
  },
  {
